class Config():
    def __init__(self):
        ...
        self.mode = "NONE"
        self.loss = "L1"
        self.result = "/scratch/podishet/Rec_UNet_with_pus_ps_shallow/results"
        ...
        self.epochs = 1000
        self.checkpointpath = "/scratch/podishet/Rec_UNet_with_pus_ps_shallow/ckp_Rec_UNet_with_pus_ps_shallow.pt"
        self.bestmodelckp = "/scratch/podishet/Rec_UNet_with_pus_ps_shallow/best_Rec_UNet_with_pus_ps_shallow.pt"
