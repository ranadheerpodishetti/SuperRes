class Config():
    def __init__(self):
        ...
        self.mode = "NONE"
        self.loss = "L1"
        self.result = "/scratch/podishet/Recurrent_ResUnet/results"
        ...
        self.epochs = 1000
        self.checkpointpath = "/scratch/podishet/Recurrent_ResUnet/ckp_Recurrent_ResUnet_l1.pt"
        self.bestmodelckp = "/scratch/podishet/Recurrent_ResUnet/best_Recurrent_ResUnet_l1.pt"
