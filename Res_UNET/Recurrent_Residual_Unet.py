...
class R2U_Net(nn.Module):
    ...
    def __init__(self, img_ch=1, output_ch=1, t=2):
        ...
        self.conv_d3 = nn.Conv3d(filters[0]*2, output_ch, kernel_size = 1, stride =1, padding = 0 )
        self.conv_d2 = nn.Conv3d(filters[0] , output_ch, kernel_size=1, stride=1, padding=0)
