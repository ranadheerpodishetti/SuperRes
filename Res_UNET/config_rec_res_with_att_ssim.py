class Config():
    def __init__(self):
        ...
        self.mode = "NONE"
        self.loss = "SSIM"
        self.result = "/scratch/podishet/Recurrent_ResUnet_with Attention_ssim/results"
        ...
        self.epochs = 1000
        self.checkpointpath = "/scratch/podishet/Recurrent_ResUnet_with Attention_ssim/ckp_Recurrent_ResUnet_with Attention_ssim.pt"
        self.bestmodelckp = "/scratch/podishet/Recurrent_ResUnet_with Attention_ssim/best_uRecurrent_ResUnet_with Attention_ssim.pt"
