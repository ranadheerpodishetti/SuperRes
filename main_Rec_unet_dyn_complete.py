...
from config_rec_unet_dyn_complete import Config
import dynamic_unet
import Rec_UNet_with_dynconv_complete
...
if __name__ == "__main__":
    ...
    if configs.model == 'UNET':
        ...
        model = Rec_UNet_with_dynconv_complete.R2AttU_Net(configs.num_features, 1, configs.kernel_size_1, configs.stride_1,
                                                          configs.kernel_size_2, configs.stride_2,
                                                          configs.kernel_size_3)
        model.to(device)
