class Config():
    def __init__(self):
        ...
        self.mode = "NONE"
        self.loss = "NOVEL"
        self.result = "/scratch/podishet/unet_dynconv_novel/results"
        ...
        self.epochs = 1000
        self.checkpointpath = "/scratch/podishet/unet_dynconv_novel/ckp_unet_dynconv_novel.pt"
        self.bestmodelckp = "/scratch/podishet/unet_dynconv_novel/best_unet_dynconv_novel.pt"
