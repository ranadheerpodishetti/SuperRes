class Config():
    def __init__(self):
        ...
        self.mode = "NONE"
        self.loss = "L1"
        self.result = "/scratch/podishet/unet_ps_l1/results"
        ...
        self.epochs = 1000
        self.checkpointpath = "/scratch/podishet/unet_ps_l1/ckp_unet_ps_l1.pt"
        self.bestmodelckp = "/scratch/podishet/unet_ps_l1/best_unet_ps_l1.pt"
