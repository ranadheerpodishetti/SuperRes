...
from configs_semi_unet import Config
import semi_unet
...
if __name__ == "__main__":
    ...
    if configs.model == 'UNET':
        model = semi_unet.semi_unet(configs.num_features, 1, configs.kernel_size_1, configs.stride_1, configs.kernel_size_2, configs.stride_2, configs.kernel_size_3, 5)
        model.to(device)
