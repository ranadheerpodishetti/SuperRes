class Config():
    def __init__(self):
        ...
        self.loss1 = "L1"
        self.loss2 = "MS_SSIM"
        self.loss3 = "PERCEPTUAL"
        self.result = "/scratch/rajatha1/Results/Ensemble"
        ...
        self.epochs = 1000
        self.checkpointpath = "/scratch/podishet/unet_l1_deepsup/ckp_unet_L1_deepsup.pt"
        self.bestmodelckp = "/scratch/podishet/unet_l1_deepsup/best_unet_L1_deepsup.pt"
        ...
        self.training_split_ratio = 0.75
