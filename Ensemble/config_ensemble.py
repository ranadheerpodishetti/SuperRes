class Config():
    def __init__(self):
        self.dataset = "IXI"
        self.model = "SRDENSENET"
        self.mode = "DS"
        self.loss = "L1"
        self.result = "/scratch/podishet/srdensenet/Results"
        ...
        self.downsampled = "/scratch/podishet/data/Down_sampledMRI"
        self.inputsize = 10
        self.samples = 25
        self.patchsize = (16, 16, 16)
        self.patchsize_original = (32, 32, 32)
        self.maxqueue = 50
        self.patch_check = "patch.jpg"
        self.learningrate = 0.0001
        self.epochs = 1000
        self.checkpointpath = "/scratch/podishet/srdensenet/ckp_srdensenet_L1.pt"
        self.bestmodelckp = "/scratch/podishet/srdensenet/best_srdensenet_L1.pt"
