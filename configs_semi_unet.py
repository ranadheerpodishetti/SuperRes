class Config():
    def __init__(self):
        ...
        self.mode = "NONE"
        self.loss = "L1"
        self.result = "/scratch/podishet/semi_unet/results"
        ...
        self.checkpointpath_patch = "/scratch/podishet/semi_unet/ckp_semi_unet_patch.pt"
        self.bestmodelckp_patch = "/scratch/podishet/semi_unet/best_semi_unet_patch.pt"
