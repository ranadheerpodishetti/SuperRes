...
import config_rec_res_with_att_ssim
from config_rec_res_with_att_ssim import Config
import dynamic_unet
import Residual_Recurrent_with_Attention_Unet
...
if __name__ == "__main__":
    ...
    if configs.model == 'UNET':
        model = Residual_Recurrent_with_Attention_Unet.R2AttU_Net()
        model.to(device)
