class Config():
    def __init__(self):
        ...
        self.mode = "NONE"
        self.loss = "SSIM"
        self.result = "/scratch/podishet/unet_pixelunshuffle_ssim/results"
        ...
        self.epochs = 1000
        self.checkpointpath = "/scratch/podishet/unet_pixelunshuffle_ssim/ckp_unet_pixelunshuffle_ssim.pt"
        self.bestmodelckp = "/scratch/podishet/unet_pixelunshuffle_ssim/best_unet_pixelunshuffle_ssim.pt"
