...
from config_rec_unet_with_upconv_pus_shallow import Config
import dynamic_unet
import Rec_UNet_with_upconv_pus_shallow
...
if __name__ == "__main__":
    ...
    if configs.model == 'UNET':
        model = Rec_UNet_with_upconv_pus_shallow.R2AttU_Net(configs.num_features, 1, configs.kernel_size_1,
                                                            configs.stride_1, 1, configs.kernel_size_2,
