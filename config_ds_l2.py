class Config():
    def __init__(self):
        ...
        self.mode = "None"
        self.loss = "L2"
        self.result = "/scratch/podishet/unet_deepsup_l2/results"
        ...
        self.epochs = 1000
        self.checkpointpath = "/scratch/podishet/unet_deepsup_l2/ckp_unet_L2_deepsup.pt"
        self.bestmodelckp = "/scratch/podishet/unet_deepsup_l2/best_unet_L2_deepsup.pt"
