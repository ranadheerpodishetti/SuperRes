class Config():
    def __init__(self):
        ...
        self.mode = "NONE"
        self.loss = "L1"
        self.result = "/scratch/podishet/Rec_UNet_with_dynconv_shallow/results"
        ...
        self.epochs = 1000
        self.checkpointpath = "/scratch/podishet/unet_dynconv_l1/Rec_UNet_with_dynconv_shallow.pt"
        self.bestmodelckp = "/scratch/podishet/unet_dynconv_l1/Rec_UNet_with_dynconv_shallow.pt"
