class Config():
    def __init__(self):
        ...
        self.mode = "NONE"
        self.loss = "NOVEL"
        self.result = "/scratch/podishet/unet_pixelunshuffle/results"
        ...
        self.epochs = 1000
        self.checkpointpath = "/scratch/podishet/unet_pixelunshuffle/ckp_unet_pixelunshuffle.pt"
        self.bestmodelckp = "/scratch/podishet/unet_pixelunshuffle/best_unet_pixelunshuffle.pt"
