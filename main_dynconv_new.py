...
import config_dynconv_novel_new
from config_dynconv_novel_new import Config
import dynamic_unet
configs = Config()
...
if __name__ == "__main__":
    ...
    if configs.model == 'UNET':
        model = dynamic_unet.UNet(configs.num_features, configs.kernel_size_1, configs.stride_1, configs.kernel_size_2, configs.stride_2, configs.kernel_size_3)
        model.to(device)
