class Config():
    def __init__(self):
        ...
        self.mode = "DS"
        self.loss = "SSIM"
        self.result = "/scratch/podishet/unet_ssim_deepsup/results"
        ...
        self.epochs = 1000
        self.checkpointpath = "/scratch/podishet/unet_ssim_deepsup/ckp_unet_ssim_deepsup.pt"
        self.bestmodelckp = "/scratch/podishet/unet_ssim_deepsup/best_unet_ssim_deepsup.pt"
