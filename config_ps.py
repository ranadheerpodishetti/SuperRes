class Config():
    def __init__(self):
        ...
        self.mode = "NONE"
        self.loss = "NOVEL"
        self.result = "/scratch/podishet/unet_pixelshuffle/results"
        ...
        self.epochs = 1000
        self.checkpointpath = "/scratch/podishet/unet_pixelshuffle/ckp_unet_pixelshuffle.pt"
        self.bestmodelckp = "/scratch/podishet/unet_pixelshuffle/best_unet_pixelshuffle.pt"
