class Config():
    def __init__(self):
        ...
        self.mode = "NONE"
        self.loss = "SSIM"
        self.result = "/scratch/podishet/unet_dynconv_ssim/results"
        ...
        self.epochs = 1000
        self.checkpointpath = "/scratch/podishet/unet_dynconv_ssim/ckp_unet_dynconv_ssim.pt"
        self.bestmodelckp = "/scratch/podishet/unet_dynconv_ssim/best_unet_dynconv_ssim.pt"
