...
import UNet_pixel_unshuffle
import config_pus_ssim
from config_pus_ssim import Config
import dynamic_unet
configs = Config()
...
if __name__ == "__main__":
    ...
    if configs.model == 'UNET':
        model = UNet_pixel_unshuffle.UNet(configs.num_features, configs.kernel_size_1, configs.stride_1, configs.kernel_size_2, configs.stride_2, configs.kernel_size_3)
        model.to(device)
