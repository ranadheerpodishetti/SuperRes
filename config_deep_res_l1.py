class Config():
    def __init__(self):
        ...
        self.mode = "NONE"
        self.loss = "L1"
        self.result = "/scratch/podishet/Deep_ResUnet/results"
        ...
        self.epochs = 1000
        self.checkpointpath = "/scratch/podishet/Deep_ResUnet/ckp_Deep_ResUnet_l1.pt"
        self.bestmodelckp = "/scratch/podishet/Deep_ResUnet/best_Deep_ResUnet_l1.pt"
