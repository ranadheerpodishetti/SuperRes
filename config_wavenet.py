class Config():
    def __init__(self):
        ...
        self.mode = "NONE"
        self.loss = "L1"
        self.result = "D:/results/results_new"
        self.trainlogs = "traininglogs"
        self.validlogs = "validlogs"
        self.images = "tensor_vis"
        self.data = "E:/master/sem2/superres/execution/info-data.csv"
        self.original_path = "original_subject.nii.gz"
        self.down_path = "down_subject.nii.gz"
        self.groundtruth = "E:/master/sem2/superres/execution/original_normalized"
        self.downsampled = "E:/master/sem2/superres/execution/downsampled_interpolated"
        self.inputsize = 10
        self.samples = 2
        ...
        self.epochs = 1000
        self.checkpointpath = "/scratch/podishet/wavenet/ckp_wavenet.pt"
        self.bestmodelckp = "/scratch/podishet/wavenet/best_wavenet.pt"
        self.checkpointpath_patch = "/scratch/podishet/wavenet/ckp_wavenet_patch.pt"
        self.bestmodelckp_patch = "/scratch/podishet/wavenet/best_wavenet_patch.pt"
