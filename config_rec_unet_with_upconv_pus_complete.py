class Config():
    def __init__(self):
        ...
        self.mode = "NONE"
        self.loss = "L1"
        self.result = "/scratch/podishet/Rec_UNet_with_upconv_pus_complete/results"
        ...
        self.epochs = 1000
        self.checkpointpath = "/scratch/podishet/Rec_UNet_with_upconv_pus_complete/ckp_Rec_UNet_with_upconv_pus_complete.pt"
        self.bestmodelckp = "/scratch/podishet/Rec_UNet_with_upconv_pus_complete/best_Rec_UNet_with_upconv_pus_complete.pt"
