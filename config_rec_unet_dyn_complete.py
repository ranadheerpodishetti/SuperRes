class Config():
    def __init__(self):
        ...
        self.mode = "NONE"
        self.loss = "L1"
        self.result = "/scratch/podishet/Rec_UNet_with_dynconv_complete/results"
        ...
        self.inputsize = 10
        self.samples = 25
        self.patchsize = (48, 48, 48)
        self.patchsize_original = (48, 48, 48)
        self.maxqueue = 50
        self.patch_check = "patch.jpg"
        self.learningrate = 0.0001
        self.epochs = 1000
        self.checkpointpath = "/scratch/podishet/unet_dynconv_l1/Rec_UNet_with_dynconv_complete.pt"
        self.bestmodelckp = "/scratch/podishet/unet_dynconv_l1/Rec_UNet_with_dynconv_complete.pt"
